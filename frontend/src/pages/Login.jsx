...
export default function Login() {
  ...
  <Col xs={12} sm={10} md={8} lg={7} >
          <Form onSubmit={handleSubmit} className="p-4 shadow rounded bg-white">
            <Form.Label className="text-center d-block mt-4 mb-5 form-label-custom">Entrez vos identifiants de connexion</Form.Label>
            ...
            <Button variant="primary" type="submit" className="w-50 mx-auto py-3 rounded-pill fw-semibold bouton-login">
              CONNEXION
            </Button>
          </Form>
        </Col>
